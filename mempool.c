//
// This file defines all functions required to manipulate transaction records in the mempool.
// In this iteration of the file, an aging feature is added which increases the priority of 
// transactions that have been in the mempool for a long time to ensure they don't starve.
